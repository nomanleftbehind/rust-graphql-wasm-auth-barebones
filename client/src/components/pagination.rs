...
#[function_component(RelNavButtons)]
pub fn rel_nav_bButtons(props: &Props) -> Html {
    let Props {
        page,
        total_pages,
        route_to_page: to,
...
#[function_component(RenderLinks)]
pub fn render_links(props: &RenderLinksProps) -> Html {
...
#[function_component(RenderLink)]
pub fn render_link(props: &RenderLinkProps) -> Html {
